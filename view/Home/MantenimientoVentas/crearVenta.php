    ...
    <body>
        ...
        <div class="container col-10 p-5" id="cont_form_art_venta">
            <div class="justify-content-center mt-5 border bg-light p-5">
                <form class="form-inline pb-4" action="/action_page.php">
                    ...
                    <div class="container d-flex mb-3 mt-5">
                        ...
                        <input type="number" style="font-size: 15px;" id="client_id" min="1" value="1" onchange="cantArt(this.value)" name="cant_prod" class="form-control mb-2 mr-sm-2 col-2" autofocus>
                        <button type="button" onclick="insertar_filas()" class="btn_gene_venta" id="btn_get_art">Agregar Artículo</button>
                    </div>
                    ...
                    <input style="font-size: 15px; font-weight:bold" type="text" class="form-control mb-2 col-2" disabled name="total_prod" id="id_cobrador">
                    <input style="font-size: 15px; font-weight:bold" type="text" class="form-control mb-2 col-2" disabled name="total_prod" id="id_vendedor">
                    ...
                    <button type="button" class="btn btn-primary btn-block">Generar Venta</button>
                </form>
            </div>
        </div>
